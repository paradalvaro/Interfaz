$(document).ready(function() {
	$.Juitter.start({
		...
		searchObject:"caracas, cola,trafico", // needed, you can insert a username here or a word to be searched for, if you wish multiple search, separate the words by comma.
		...
		loadMSG: "Cargando Mensajes...", // Loading message, if you want to show an image, fill it with "image/gif" and go to the next variable to set which image you want to use on 
		imgName: "loader.gif", // Loading image, to enable it, go to the loadMSG var above and change it to "image/gif"
		total: 5, // number of tweets to be show - max 100
		readMore: "Leelo en Twitter", // read more message to be show after the tweet content
	...
	$("#aIphone").click(function(){
		...
		$.Juitter.start({
			...
			searchObject:"caracas,trafico,cola",
